...
export const certifications: CertificationItem[] = [
  {
    ...
    imageAlt: 'Hube Computer OJT certificate',
    isSensitive: true,
  },
  {
    title: 'NC II — Computer System Servicing (CSS)',
    issuer: 'TESDA (Technical Education and Skills Development Authority)',
    notes: 'National Certificate II — Computer System Servicing (CSS). Full certificate available upon request.',
    imageSrc: '/assets/certificates/ncii-css.jpg',
    imageAlt: 'NC II Computer System Servicing (blurred)',
    isSensitive: true,
  },
  {
